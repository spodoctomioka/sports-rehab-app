  ...
  const data: D[] = [
    {
      ...
      ngList: ["スポーツ活動・体育参加（非管理の場合は14日間禁止）","スクリーン（スマホ・PC・TV）の長時間使用","学業・集中を要する作業","騒がしい環境","コンタクットプレー"],
      rehabMenu: [
    ...
    },
    {
      ...
      ngList: ["最大予測心拍数70%以上の運動","レジスタンス・トレーニング（この段階は禁止）","スポーツ特異的動作","コンタクットプレー","症状増悪を無視した無理な継続"],
      rehabMenu: [
    ...
    },
    {
      ...
      ngList: ["頭部への衝撃を伴う動作（ヘディング・タックル等）","コンタクットプレー","レジスタンス・トレーニング（まだ禁止）","チーム全体練習への参加"],
      rehabMenu: [
    ...
    },
    {
      ...
      summary: "スポーツ固有運動で無症状を確認。GRTP Level 4：コンタクットなしの練習ドリルに参加します。パス・ドリルなどより複雑な練習へ進み、この段階から段階的にレジスタンス・トレーニングの開始も可能です。24時間無症状でLevel 5（フルコンタクット）へ。",
      okList: ["コンタクットなし練習ドリルへの全参加","パス・ドリルなど複雑な練習","レジスタンス・トレーニングの漸進的開始（Level 4から解禁）","睡眠衛生の改善"],
      ngList: ["コンタクットプレー","試合出場（医師許可まで）"],
      rehabMenu: [
        { title: "非コンタクット練習ドリル", sets: "チーム練習参加", note: "パス・ドリル等。複雑な練習に進む", details: "チームの練習メニューに参加しますが、コンタクットのないドリルに限定します。例：パス・ドリル、シュート練習、戦術確認など「より複雑な練習」への参加が推奨されます。チームメイト・スタッフへ事前に状況を説明し、偶発的なコンタクットを避けるよう協力を得てください。" },
      ...
      timeline: [
        { week: "Level 4（24時間）",  goal: "非コンタクット全ドリルで無症状", activity: "パス・ドリル・レジスタンス開始" },
        { week: "Level 5（移行条件）", goal: "医師によるコンタクット許可",      activity: "医師許可後にLevel 5開始" },
      ],
