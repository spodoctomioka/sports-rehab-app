...
export const TESTS_BY_INJURY: Record<InjuryId, TestItem[]> = {
  ...
  concussion: [
    ...
    { id: "okContact",   title: "コンタクト練習で症状増悪なし", description: "医師の許可を得てフル・コンタクト練習を実施し、24時間以内に症状増悪がなかったか。医師許可がまだ出ていない場合は「医師未許可」を選択してください。",                                                                                                                                                    icon: "🏅" },
  ],
  slap_lesion: [
...
function concussionPlan(p: GeneratePlanParams): RehabPlan {
  ...
  const data: D[] = [
    {
      // GRTP Level 1（目安：受傷後最低24時間、非管理は最低14日間）
      summary: "頭痛が残っています。心身の完全な休養が必要です（GRTP Level 1）。医師管理下であれば最低24時間、医師管理外の場合は受傷後最低14日間はいかなる活動も禁止です。無症状になることが次フェーズへの条件です。",
      ...
      timeline: [
        { week: "症状消失まで",  goal: "完全症状消失（無症状）", activity: "完全安静 → Level 2へ" },
        { week: "Level 2〜6",    goal: "段階的復帰",              activity: "各24時間以上・無症状で次レベルへ" },
      ],
      alert: "【重要】医師管理外の場合、受傷後最低14日間はいかなる活動も禁止です。脳震盪後の「Second Impact Syndrome」は生命の危険があります。症状が残る間は絶対に競技復帰しないでください。",
    },
    {
      // GRTP Level 2（目安：受傷後48時間）
      summary: "頭痛が消失し、GRTP Level 2に進んでいます。最大予測心拍数の70%未満でのウォーキング・水泳・固定自転車エルゴを24時間実施し、無症状を確認してから次レベルへ進みます。レジスタンス・トレーニングはこの段階では禁止です。",
      ...
      rehabMenu: [
        { title: "ウォーキング（軽度有酸素）",  sets: "20〜30分",           note: "最大予測心拍数70%未満。症状増悪なければ継続", details: "最大予測心拍数は「220－年齢」で概算できます（例：20歳なら220−20=200、70%は140拍/分）。この心拍数を超えないよう管理しながらウォーキングを行います。運動中・運動後24時間以内に頭痛・めまい・吐き気が増悪した場合は即中止しLevel 1に戻ってください。24時間無症状であればLevel 3へ進みます。" },
        { title: "固定自転車エルゴ（軽負荷）", sets: "15〜20分",            note: "低抵抗・低速。転倒リスクがなく心拍管理しやすい", details: "固定自転車エルゴは転倒リスクがなく心拍数を安定してコントロールできるため、GRTP Level 2に適した運動です。低抵抗・ゆっくりしたペースで開始し、最大予測心拍数の70%を超えないよう注意します。レジスタンス・トレーニング（筋力トレーニング）はこの段階では禁止です。" },
      ...
      timeline: [
        { week: "Level 2（24時間）", goal: "軽度有酸素で無症状",    activity: "ウォーキング・固定自転車・水泳（HR70%未満）" },
        { week: "Level 3（移行条件）", goal: "24時間無症状の確認",   activity: "無症状確認後にLevel 3開始" },
      ],
      alert: "運動後24時間以内に頭痛・めまいなどの症状増悪があればLevel 1に戻り完全安静を再開してください。レジスタンス・トレーニングはLevel 4まで禁止です。",
    },
    {
      // GRTP Level 3（目安：受傷後72時間）
      summary: "軽度有酸素運動で無症状を確認。GRTP Level 3：スポーツ固有の運動（ランニング・ドリル）を24時間実施します。頭部に衝撃を与える運動は禁止です。24時間無症状であればLevel 4へ進みます。",
      ...
      rehabMenu: [
        { title: "ランニング・ドリル",        sets: "20〜30分",   note: "方向転換・スプリント含む。頭部衝撃なし", details: "競技コートや練習場でのランニングドリルを実施します。直線走から始め、方向転換・加速減速を含む競技特異的な動作へ移行します。この段階ではまだ頭部への衝撃（ヘディング・タックル等）は絶対に禁止です。毎回前後で症状スコアを確認し、増悪した場合はLevel 2に戻ってください。" },
      ...
      timeline: [
        { week: "Level 3（24時間）", goal: "スポーツ固有運動で無症状", activity: "ランニング・ドリル（頭部衝撃なし）" },
        { week: "Level 4（移行条件）", goal: "24時間無症状の確認",        activity: "無症状確認後にLevel 4開始" },
      ],
      alert: "ランニングドリル後24時間以内に症状が増悪した場合はLevel 2に戻ること。ヘディング・タックルなど頭部への衝撃は絶対に禁止。",
    },
    {
      // GRTP Level 4（目安：受傷後96時間）
      summary: "スポーツ固有運動で無症状を確認。GRTP Level 4：コンタクトなしの練習ドリルに参加します。パス・ドリルなどより複雑な練習へ進み、この段階から段階的にレジスタンス・トレーニングの開始も可能です。24時間無症状でLevel 5（フルコンタクト）へ。",
      okList: ["コンタクトなし練習ドリルへの全参加","パス・ドリルなど複雑な練習","レジスタンス・トレーニングの漸進的開始（Level 4から解禁）","睡眠衛生の改善"],
      ...
      rehabMenu: [
        ...
        { title: "レジスタンス・トレーニング（漸進的開始）", sets: "軽負荷から開始", note: "Level 4から解禁。軽重量・低強度から段階的に", details: "Level 4からレジスタンス・トレーニング（筋力トレーニング）が解禁されます。軽負荷・低強度から始め、症状増悪がなければ段階的に負荷を上げます。最初はマシン種目など、頭部への負荷が少ない種目から開始してください。" },
      ...
      timeline: [
        { week: "Level 4（24時間）",  goal: "非コンタクト全ドリルで無症状", activity: "パス・ドリル・レジスタンス開始" },
        { week: "Level 5（移行条件）", goal: "医師によるコンタクト許可",      activity: "医師許可後にLevel 5開始" },
      ],
      alert: "コンタクト練習（Level 5）への復帰は必ず医師（スポーツ専門医）の許可を得てから。許可なしのコンタクト参加は絶対に禁止です。",
    },
    {
...
function genericPlan(p: GeneratePlanParams): RehabPlan {
  ...
  if (p.injuryId === "ACL") {
    ...
    const aclMenu: Record<number, RehabMenuItem[]> = {
      ...
      4: [
        ...
        { title: "コンタクト練習",         sets: "段階的参加",   note: "医師書面許可後のみ",             details: "コンタクトを伴う練習は必ず医師の書面許可を得てから開始します。許可書はトレーナー・コーチが保管することを推奨します。" },
      ],
    };
    ...
    return {
      ...
      ngList: phaseIdx <= 1
        ? ["ランニング・ジャンプ","深いスクワット（膝90°以上）","コンタクトプレー","急激な方向転換"]
        : phaseIdx <= 2
        ? ["方向転換・カット","コンタクトプレー","ジャンプからの片足着地（まだ不可）"]
        : ["医師許可なしのコンタクトプレー"],
      ...
      phaseTracker: [
        ...
        { phase: 5, name: "復帰期",       desc: "コンタクト・試合",       duration: "6〜9ヶ月" },
      ],
    };
  }
  ...
  return {
    ...
    ngList: isAcute
      ? ["患部への強い負荷","疼痛を誘発する動作","コンタクトプレー","温熱療法（48時間以内）"]
      : isSubacute
...
function slapPlan(p: GeneratePlanParams): RehabPlan {
  ...
  const data: D[] = [
    ...
    },
    {
      ...
      ngList: [isRepair ? "投球動作（術後3ヶ月まで禁止）" : "投球動作（術後1ヶ月まで禁止）","外旋の過剰伸張（修復群は特に注意）","コンタクトプレー"],
      rehabMenu: [
  ...
  const data: D[] = [
    {
      ...
      ngList: ["走行・跳躍動作", "開脚・強制伸張（adductor系は特に注意）", "股関節への強い負荷", "コンタクトプレー"],
      rehabMenu: [
    ...
    },
    {
      ...
      ngList: ["ランニング（疼痛ある場合）", "強制的な開脚ストレッチ", "高負荷の内転筋運動", "コンタクトプレー"],
      rehabMenu: [
    ...
    },
    {
      ...
      okList: ["直線ジョグ〜80%ランニング", "方向転換ドリル（低速）", "競技特異的ドリル（非コンタクト）", "筋力強化継続"],
      ngList: ["フルスプリント（疼痛ある場合）", "急激な方向転換", "コンタクトプレー"],
      rehabMenu: [
    ...
    {
      summary: "スプリントはクリア。競技特異的な方向転換・コンタクトへの最終移行期です。",
      okList: ["フルスプリント", "方向転換・カッティング", "競技特異的ドリル（コンタクト段階的）", "強化プログラム継続"],
      ...
      timeline: [
        { week: "10〜14週", goal: "競技特異的動作可", activity: "全ドリル・コンタクト練習" },
    ...
    },
    {
      ...
      okList: ["全競技活動・試合出場", "コンタクト・全力スプリント", "内転筋強化プログラムの継続（週2〜3回）"],
